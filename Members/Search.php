...
if(isset($_SESSION['user']['id'])){
    ...
    $usrLib = new Users();
    $user = $usrLib->get($_COOKIE['user_id']);
                       ...
                       <?php } ?>
                        ...
                        <td>
                            <a class="noprint btn btn-primary btn-mini" target="_blank" href="<?PHP ECHO webUrl ?>Members/View?id=<?= $mData['MembersId'] ?>">
                                ...
                                <?php }	?>        
							<?php if ($_ADMIN  && $UserTypeId==1) {	?>    
                                   <a class="noprint btn btn-primary btn-mini" data-ajax="true" data-ajax-begin="makedpt('MembersBook')" data-ajax-loading="#load" data-ajax-mode="replace" data-ajax-success="showdpt('MembersBook')" data-ajax-update="#MembersBook > #modal-body" href="<?PHP ECHO webUrl ?>Members/MembersBookEdit?MembersId=<?= $mData['MembersId'] ?>">
                                <i class="icon-ok"></i>Book</a> 
                                <?php }	?> 
                        </td>
						<?php if ($_ADMIN) { ?>
                            <td>
