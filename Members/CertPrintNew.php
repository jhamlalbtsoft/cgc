...
<style type ="text/css" >
body
{font-family :Cambria  ;font-size : 16px;color:Blue;font-weight:bold;
    }
...
<div style ="z-index:100000;position:absolute  ;top:39.2%;left:24.2%"><?= $RegistrationNo ?></div>
<div style ="z-index:100000;position:absolute  ;top:39.2%;left:83.7%"> <?= $memData['GroupsId']-100 ?>  </div>
<div style ="z-index:100000;position:absolute  ;top:54.2%;left:23.0%;font-size : 14px;" class="name">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?= $Representative ?></div>
  
  
     
 <div style ="z-index:100000;position:absolute  ;top:57.6%;left:24%" class="name"><?= $FirmName ?> </div>      
 <div style ="z-index:100000;position:absolute  ;top:61.3%;left:24%" class="name"><?= $addr ?> </div>      
            
<div style ="z-index:100000;position:absolute  ;top:87%;left:8%" class="bottom">Issued By:  admin, &nbsp;  Signature  </div><!--div style ="z-index:100000;position:absolute  ;top:103%;left:5%; font-size:12px; color:Black; font-weight:normal">Registration No:  <?= $memData['RegistrationNoOld'] ?>  </div-->
</div>  </body></html>
