...
if(isset($_SESSION['SixDRN'])){
    unset($_SESSION['SixDRN']);
  ...
  <div class="span12">
                  ...
                  <h4><?php if($MembersId>0) echo "Edit"; else echo "New"; ?> Members</h4>
                   <div class="row-fluid">
                    ...
                    <?php $SixDRN = random_int(100000, 999999); ?>
                      <input data-val="true" id="SixDRN" name="SixDRN" type="hidden" value="<?= $SixDRN ?>" />
  ...
  <!--a class="btn btn-danger btn-mini" id="arealink"    data-ajax="true" data-ajax-begin="makedpt('AddArea')" data-ajax-loading="#load" data-ajax-mode="replace" data-ajax-success="showdpt('AddArea')" data-ajax-update="#AddArea > #modal-body" href="Members/Area-Create?popup=1&eid=AddArea&fname=LoadArea&CityId=1">Add</a-->
                 ...
                 <div class="row-fluid">
                      ...
                      <label for="Old_Registration_No">Registration No</label>
                        <input class="span12" id="RegistrationNoOld" name="RegistrationNoOld" placeholder="" type="text" value="<?= $RegistrationNoOld ?>"  data-val-required="Registration No is required." required /><!--readOnly-->
                ...
                <div class="span4">
                  ...
                  <div class="span4">     
                      ...
                      <label for="Upload_file">Upload file</label>
                        <iframe src="<?PHP ECHO webUrl ?>Web_Image_Upload2.php?File=1&amp;id=MemDoc&amp;type=1&amp;size=150&amp;SixDRN=<?=$SixDRN?>" width="500px" height="50px"  frameborder="0" scrolling=no >
                  ...
                  <div class="row-fluid">
                   ...
                   <div class="row-fluid">
                     ...
                     <div class="span4">
                       ...
                       <div class="span4">
                      <label for="Upload_file">Upload file</label>
                        <iframe src="<?PHP ECHO webUrl ?>Web_Image_Upload2.php?File=1&amp;Pos=1&amp;id=ImageRep1&amp;SixDRN=<?=$SixDRN?>&amp;size=150" width="500px" height="50px"  frameborder="0" scrolling=no ></iframe>
        ...
        <input class="datefield span12" id="DOBRep2" name="DOBRep2" type="text" value="<?= $DOBRep2 ?>" />
                   ...
                   <div class="row-fluid">
                      ...
                      <label for="SMS_Group">SMS Group</label>
                       ...
                       <div class="span4">
                      <label for="Upload_file">Upload file</label>
                        <iframe src="<?PHP ECHO webUrl ?>Web_Image_Upload2.php?File=1&amp;Pos=2&amp;id=ImageRep2&amp;SixDRN=<?=$SixDRN?>&amp;size=150" width="500px" height="50px"  frameborder="0" scrolling=no ></iframe>
