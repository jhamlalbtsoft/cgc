...
<html lang="zxx"> 
    ...
    <body>
        ...
        <div class="sidebarModal modal right fade d-none" id="sidebarModal" tabindex="-1" role="dialog">
                        ...
                        <div class="sidebar-contact-info">
                            ...
                            <ul class="info-list">
                                ...
                                <li>
                                    ...
                                    <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#5b333e3737341b283a352e75383436">
                                        <span class="__cf_email__" data-cfemail="83ebe6efefecc3f0e2edf6ade0ecee">[email&#160;protected]</span>
                                    </a>
                                </li>
        ...
        <div class="page-banner-area bg-2 d-none">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contacts-form">
                            ...
                            <form id="contactForm1" method="post" action="<?=base_url('User/checkuser')?>">
                                <?php 
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" id="username" class="form-control form-control-sm" required data-error="Please enter your user name" required/>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <label>Enter User Password <span class="text-danger">*</span></label>
                                            <input type="password" name="password" id="password" required data-error="Please enter your Password" class="form-control" />
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
          ...
          $(document).ready(function() {
           ...
           var year;
            $(document).ready(function() {
            $('#Current_level, #Passed_Year').on('change', function() {
              
              year = $('#Passed_Year').val();
              if (year === "Choose Year") {
