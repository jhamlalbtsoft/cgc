...
<body>
    <form name="form1" method="post" action="showcard?MembersId=<?= $MembersId ?>&amp;Card=1" id="form1">
    <div>
		<img src="<?PHP ECHO webUrl ?>Members/Card?MembersId=<?= $MembersId ?>&amp;Card=<?= $Card ?>&amp;Rep=<?= $Rep ?>" />
		<img src="<?PHP ECHO webUrl ?>Members/Card?MembersId=<?= $MembersId ?>&amp;Card=<?= $Card ?>b&amp;Rep=<?= $Rep ?>" />
  <?php 
