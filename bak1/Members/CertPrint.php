...
.name{letter-spacing:2px; font-size:100%}
.issue{font-size:120%}
 </style></head><body style="margin:0px!important"><div style="position:relative; "><img style="width: 100%;z-index:999;<?= $imgVisible ?>"src="../Image/cert2020v1.jpg"/>
<div style ="z-index:100000;position:absolute  ;top:26.5%;left:28%"><?= $RegistrationNo ?></div>
<div style ="z-index:100000;position:absolute  ;top:26.5%;left:82%"> <?= $memData['GroupsId']-100 ?>  </div><div style ="z-index:100000;position:absolute  ;top:51.3%;left:20%" class="name">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?= $FirmName ?></div>
  
  
     
 <div style ="z-index:100000;position:absolute  ;top:47%;left:24%" class="name"><?= $Representative?> </div>      
            
<div style ="z-index:100000;position:absolute  ;top:85%;left:4%" class="bottom">Issued By:  admin, &nbsp  Signature  </div><!--div style ="z-index:100000;position:absolute  ;top:103%;left:5%; font-size:12px; color:Black; font-weight:normal">Registration No:  <?= $memData['RegistrationNoOld'] ?>  </div-->
</div>  </body></html>