...
if(isset($_REQUEST['Updated'])){
	$Updated = $_REQUEST['Updated'];//18
}

require PATH_LIB . "lib-masters.php";
$mastersLib = new Masters();

$requests = $mastersLib->LoadRequest($Approved, $Updated);
//print_r($requests);
include('header.html');
?>
                            ...
                            <div class="row-fluid dataTables_wrapper">
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                            ...
                                            <a class="btn btn-danger btn-mini" href="<?PHP ECHO webUrl ?>Members/Request-Index?Approved=1" data-ajax-update="#master" data-ajax-mode="replace"
                                                    data-ajax-loading="" data-ajax="true"> <i class="icon-ok"></i>Approved</a>
                                    </div>
                                   <div class="span4">
                                        
                                            <a class="btn btn-danger btn-mini" href="<?PHP ECHO webUrl ?>Members/Request-Index?Approved=0" data-ajax-update="#master" data-ajax-mode="replace"
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                       <a class="btn btn-danger btn-mini" href="<?PHP ECHO webUrl ?>Members/Request-Index?Approved=1&Updated=1" data-ajax-update="#master" data-ajax-mode="replace"
                                                    data-ajax-loading="" data-ajax="true"> <i class="icon-ok"></i>Updated</a>
                                    </div>
                                    <div class="span8">
                                        <a class="btn btn-danger btn-mini" href="<?PHP ECHO webUrl ?>Members/Request-Index?Approved=1&Updated=0" data-ajax-update="#master" data-ajax-mode="replace"
