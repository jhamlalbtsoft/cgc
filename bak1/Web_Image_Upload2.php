  ...
  <div class="row"style="padding:0 0px">
    <div class="span12"style="padding:0 0px">
      <div class="row-fluid column-seperation" style="padding:0 10px">
        ...
        <div class="span5">
    <form name="form1" method="post" action="./Web_Image_Upload2.php?File=<?= $_REQUEST['File'] ?>&amp;id=<?= $_REQUEST['id'] ?>&amp;size=150" id="form1" enctype="multipart/form-data">
    <div>
	...
	<tr>
		<td>
                    <input type="file" name="FileUpload1" id="FileUpload1" style="height:30px;width:200px;" />
