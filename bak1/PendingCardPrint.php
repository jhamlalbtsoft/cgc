...
<div id="container">
	<iframe border="0" id="Mem" style="width:100%;border:0px solid;" src="<?PHP ECHO webUrl ?>Members/PendingCardPrint?Status=1" scrolling="no" onload='javascript:resizeIframe(this);'></iframe>
</div>
